...
const ChequeLoading = () => {
    return (
        <>
            <div className="data_trans"><span className={'loading'}>16 July</span>
                <div className="trans_items">
                    <div className="trans_item">
                        <div className="left">
                            <div className="img loading">
                                <svg style={{opacity:'0'}}  width="50" height="50" viewBox="0 0 50 50" fill="none"
                            ...
                            <div className="title"><h2 className={'loading'}>MEDİCLUB</h2></div>
                        </div>
                        <div className="right">
                            <div className="plus loading" >+696969 ₼</div>
                            <div className="plus_from loading">26.08 ₼</div>
                        </div>
                    </div>
                </div>
            </div>
